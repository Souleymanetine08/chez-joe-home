...
export default function RamadanHero() {
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-primary via-primary-dark to-primary overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container-custom relative z-10 text-center px-4">
        ...
        >
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-card mb-4">
            Collection{" "}
            <span className="text-gradient-gold">Ramadan 2025</span>
          </h1>
